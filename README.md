...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/nds2-client-swig-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nds2-client-swig-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add nds2-client-java nds2-client-swig python-nds2-client
# for installing globally
pixi global install nds2-client-java nds2-client-swig python-nds2-client
```
...
It is possible to list all of the versions of `nds2-client-java` available on your platform:
...
```
pixi search nds2-client-java --channel conda-forge
```
